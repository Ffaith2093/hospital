...
const HtmlWebpackPlugin = require('html-webpack-plugin');//HTTPWebpackPlugin这个会经常用到，是可以将你所有配置好的东西打包成一个html文件，功能很强大
module.exports = merge(common, {
    output: {
        path: __dirname + "/../src/assets/dist/",//打包后输出的文件地址，我这里配置的地址是我项目中SpringMVC存放页面的地方，如果你只需要前台请自行修改这里的配置，其实不修改也行，它会自动创建这个地址的，__dirname是webpack中的全局关键字，存放的项目的根目录的绝对路径
